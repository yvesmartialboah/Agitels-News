...
<head>
    ...
    <body>
        ...
        <div id="wrapper" class="wrapper">
            ...
            <section class="bg-primary pb-100">
                <div class="container">
                    <div class="text-center">
                    	<br> <br>
                        <img src="{{asset('view/img/404.png')}}" height="100px" alt="404" class="img-fluid m-auto">
                        <a href="{{route('accueil')}}" class="btn-gtf-ltl-64">Retour à la page d'accueil</a>
                        <h2 class="title-regular-light size-c60 mb-60">Ooops... cette page n'existe pas !!!</h2>
                    </div>
                </div>
            </section>
